...
**Core Workflow:**
1.  **Sage (Extraction):** Converts user intent into structured context/knowledge graphs.
2.  **Weaver (Mapping):** Transforms knowledge into task-oriented Directed Acyclic Graphs (DAGs).
...
`The Council` architecture is validated through high-fidelity performance benchmarking of archetypal operators.
